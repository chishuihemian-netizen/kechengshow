...
- 四个篇章现已分别替换为新展板：东方叙事 16 张、新锐探索 14 张、青春时尚 12 张、伴手礼挂件 8 张。`boards-manifest.json` 记录了每张展板对应的原始文件名。
- 每章可用作品区下方的 PREV / NEXT 浏览所有展板；放大后可点左右按钮，手机上也可左右滑动。浏览完全部 50 张并关闭放大视图后，才会出现致谢页面。
